...
import com.example.tensor_flow.ml.MODELOPHOTO;
...
protected void setFragment() {
    ...
    public void PersonalizedModel(View v) {
        try {
            MODELOPHOTO model = MODELOPHOTO.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            MODELOPHOTO.Outputs outputs = model.process(image);
